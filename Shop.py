...
def add():
    while True:
        ...
        products.append(dic)
        with open('D:\pythonclass\Session08task\shop.txt', 'a') as f:  
...
def delete():
    while True:
        ...
        if id == 'f': 
            break
        with open('D:\pythonclass\Session08task\shop.txt', 'r') as f:
            lines = f.readlines()
        with open('D:\pythonclass\Session08task\shop.txt', 'w') as f:
            for line in lines:
                if line.split(',')[0] != id:
                    f.write(line)
        ...
        for product in products:
            if product["ID"] == item_id:
                ...
                if int(product["Count"]) >= count:
                    ...
                    print("Sorry, the stock is not enough for your request.")
